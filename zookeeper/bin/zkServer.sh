...
-Dzookeeper.ssl.keyStore.location=/var/ssl/kafka/server.keystore.jks 
-Dzookeeper.ssl.keyStore.password=$SSL_PASSWORD 
-Dzookeeper.ssl.trustStore.location=/var/ssl/kafka/truststore.jks 
-Dzookeeper.ssl.trustStore.password=$SSL_PASSWORD
-Dzookeeper.sslQuorum=true 
-Dzookeeper.ssl.quorum.keyStore.location=/var/ssl/kafka/server.keystore.jks 
